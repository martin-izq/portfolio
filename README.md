...
- Demonstrate clean front-end architecture and design consistency
...
├── resume.html         # Static, ATS-friendly resume
├── script.js           # Language switching and dynamic content
├── style.css           # Style
├── data
│   ├── resume.en.json  # English version of resume in JSON
│   ├── resume.es.json  # Spanish version of resume in JSON
└── assets
    └── logo.svg        # M logo
```
